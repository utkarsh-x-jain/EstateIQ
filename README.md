...
| File | Purpose |
|---|---|
| `app.py` | Streamlit web application and prediction interface |
| `train.py` | Model training, evaluation, comparison, and model saving |
| `train.csv` | Historical housing dataset |
| `house_price_model.pkl` | Saved best-performing trained model |
...
EstateIQ can be deployed as a Streamlit application.
